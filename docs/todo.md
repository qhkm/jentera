...
| The approval window during a hand-off | Still 60 s (gap 4 below), the same clock as the root task's, so an owner slow to approve fails that specialist's part too | Revisited together with gap 4, in "Gaps in what is live" |
