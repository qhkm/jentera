...
import { ArrowRight, List, X, Play, PaperPlaneTilt, CalendarBlank, Browser, Check, Clock, FileText } from '@phosphor-icons/react';
...
export default function LandingV3() {
  ...
  return <div className="lv3" lang="en">
    ...
    <div className="lv3-preview"><span>Design preview · V3</span><Link to="/">Original</Link><Link to="/landing-v2">Version 2 <ArrowRight size={12} /></Link></div>
    <header className="lv3-header lv3-wrap">
      <Link className="lv3-brand lv3-original-brand" to="/landing-v3" aria-label="Jentera version 3 home"><JenteraMark size={36} /><span>Jentera</span></Link>
      <nav className="lv3-nav" aria-label="Main navigation"><a href="#lv3-product">Product</a><a href="#lv3-team">Use cases</a><Link to="/connect">Connections</Link><Link to="/pricing">Pricing</Link><a href="#lv3-how">How it works</a></nav>
    ...
    {menuOpen && <nav className="lv3-mobile-menu" id="lv3-mobile-menu" aria-label="Mobile navigation" onClick={() => setMenuOpen(false)} onKeyDown={event => { if (event.key === 'Escape') { setMenuOpen(false); menuButton.current?.focus(); } }}><a href="#lv3-product">Product</a><a href="#lv3-team">Use cases</a><Link to="/connect">Connections</Link><Link to="/pricing">Pricing</Link><a href="#lv3-how">How it works</a><Link to="/signin">Log in</Link></nav>}
    <main id="lv3-main">
      <section className="lv3-hero" aria-labelledby="lv3-title">
        <div className="lv3-hero-copy lv3-wrap">
          <span className="lv3-badge"><span aria-hidden="true">🇲🇾</span> Built for Malaysian businesses</span>
        ...
        <figure className="lv3-scene" id="lv3-product">
      ...
      <section className="lv3-capabilities lv3-wrap" aria-labelledby="lv3-capabilities-title">
      ...
      <section className="lv3-story lv3-wrap" aria-labelledby="lv3-story-title"><div className="lv3-story-art"><Mascot /></div><div><span className="lv3-eyebrow">A LITTLE HELP, EVERY DAY</span><h2 id="lv3-story-title">Less busywork.<br />More of what matters.</h2><p>Give Jentera the research, the first draft, and the details to organise. Keep your time for your customers, your ideas, and the decisions only you can make.</p><span className="lv3-story-signature">Your next pair of helping hands.</span></div><span className="lv3-story-note" aria-hidden="true">Pass je kerja<br />dekat Jentera.</span></section>
      <section className="lv3-closing lv3-wrap"><Mascot /><div><h2>What’s first on your list?</h2><p>Start with one job. Make room for the work that matters.</p></div><Link className="lv3-button" to={launchOffer.href}>Get started <ArrowRight size={18} /></Link></section>
    </main>
    <footer className="lv3-footer lv3-wrap"><Link className="lv3-brand" to="/landing-v3"><Mascot /><span>Jentera</span></Link><span>Built in Malaysia. Ready for your business.</span><nav aria-label="Footer navigation"><Link to="/pricing">Pricing</Link><Link to="/privacy">Privacy</Link><Link to="/terms">Terms</Link></nav></footer>
  </div>;
}
