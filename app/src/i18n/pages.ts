...
export const PAGE_MESSAGES: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'perm.desc':
      'Your private assistant can reply to you automatically. These controls decide what Jentera may do with business data, systems, and customer-facing actions.',
    'perm.recommended': 'Recommended defaults active',
    'perm.recommended.desc': 'Routine internal work is automatic; sensitive and customer-facing actions stay controlled.',
  ...
  bm: {
    ...
    'perm.desc':
      'Pembantu peribadi boleh menjawab anda secara automatik. Kawalan ini menentukan tindakan Jentera terhadap data, sistem, dan urusan pelanggan.',
    'perm.recommended': 'Tetapan disyorkan aktif',
    'perm.recommended.desc': 'Kerja dalaman rutin adalah automatik; tindakan sensitif dan pelanggan kekal terkawal.',
