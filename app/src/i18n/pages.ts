...
export const PAGE_MESSAGES: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'ob.ch.body': 'Pick the tools you already use. Telegram starts as your private chat with AISAR; customer-facing automation is a separate choice later.',
    ...
    'su.live.body': 'Your private AISAR runtime is created from the onboarding answers you just confirmed. You can connect Telegram while it finishes installing.',
    ...
    'su.live.continue': 'Continue while AISAR sets up →',
    'su.live.fallback': 'AISAR uses its safe inline fallback until the private agent reports ready.',
    ...
    'perm.title': 'What AISAR may do on its own',
    'perm.desc':
      'Zero setup does not mean zero control. Each action sits at one of three levels, and AISAR obeys these before it does anything.',
    'perm.automatic': 'Automatic',
    'perm.automatic.desc': 'Read-only or reversible. AISAR just does it.',
  ...
  bm: {
    ...
    'ob.ch.body': 'Pilih alat yang anda sudah guna. Telegram bermula sebagai chat peribadi anda dengan AISAR; automasi untuk pelanggan ialah pilihan berasingan kemudian.',
    ...
    'su.live.body': 'Runtime AISAR peribadi anda dibina daripada jawapan onboarding yang baru disahkan. Anda boleh sambungkan Telegram sementara pemasangan diselesaikan.',
    ...
    'su.live.continue': 'Teruskan sementara AISAR disediakan →',
    'su.live.fallback': 'AISAR menggunakan fallback inline yang selamat sehingga ejen peribadi melaporkan sedia.',
    ...
    'perm.title': 'Apa AISAR boleh buat sendiri',
    'perm.desc':
      'Tiada setup bukan bermakna tiada kawalan. Setiap tindakan ada satu daripada tiga tahap, dan AISAR patuh sebelum buat apa-apa.',
    'perm.automatic': 'Automatik',
    'perm.automatic.desc': 'Baca sahaja atau boleh diundur. AISAR terus buat.',
