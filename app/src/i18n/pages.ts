...
export const PAGE_MESSAGES: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'su.live.body': 'Your business details are saved. Start your first task in web chat, and add Telegram whenever you want.',
    'su.live.progress': 'Workspace setup progress',
    'su.live.startTitle': 'Put Jentera to work',
    'su.live.startBody': 'Draft a customer reply, plan your week, or write a promotion. No WhatsApp or Telegram connection is needed.',
    'su.live.startChat': 'Start my first task →',
    'su.live.telegramOptional': 'Add Telegram for phone access (optional)',
    'su.live.profile': 'Business profile',
    'su.live.profileSaved': 'onboarding answers saved',
    'su.live.agent': 'Private business assistant',
    ...
    'su.live.provisioning': 'preparing your private workspace',
    ...
    'su.live.fallback': 'You can open chat now. If Jentera is still preparing when you send a task, wait a moment and choose “Try this again” in chat.',
    ...
    'home.firstTask.detail': 'Your setup is saved. Start with a customer reply, a weekly plan, or a promotion in web chat. No WhatsApp or Telegram connection is needed.',
    ...
    'ask.welcome.first': 'Give Jentera a first task. Choose a draft below or describe what you need. You can work here without connecting WhatsApp or Telegram.',
    'ask.first.reply.label': 'Draft a customer reply',
    'ask.first.reply.prompt': 'Draft a friendly reply to a customer asking about our prices. Use what you know about my business and placeholders for any missing details. Keep it as a draft for me to review.',
    'ask.first.plan.label': 'Plan my week',
    'ask.first.plan.prompt': 'Draft a simple weekly plan for my business with three priorities and practical next steps. Ask me about any business details you need.',
    'ask.first.promotion.label': 'Write a promotion',
    'ask.first.promotion.prompt': 'Draft a short promotion for my business. Use placeholders for any prices, offers or dates you do not know. Keep it as a draft for me to review.',
  ...
  bm: {
    ...
    'su.live.body': 'Maklumat perniagaan anda disimpan. Mulakan tugasan pertama dalam chat web, dan tambah Telegram bila-bila masa.',
    'su.live.progress': 'Kemajuan persediaan ruang kerja',
    'su.live.startTitle': 'Mula bekerja dengan Jentera',
    'su.live.startBody': 'Draf balasan pelanggan, rancang minggu anda, atau tulis promosi. Sambungan WhatsApp atau Telegram tidak diperlukan.',
    'su.live.startChat': 'Mulakan tugasan pertama →',
    'su.live.telegramOptional': 'Tambah Telegram untuk akses telefon (pilihan)',
    'su.live.profile': 'Profil perniagaan',
    'su.live.profileSaved': 'jawapan onboarding disimpan',
    'su.live.agent': 'Pembantu perniagaan peribadi',
    ...
    'su.live.provisioning': 'ruang kerja peribadi sedang disediakan',
    ...
    'su.live.fallback': 'Anda boleh membuka chat sekarang. Jika Jentera masih disediakan apabila anda menghantar tugasan, tunggu sebentar dan pilih “Cuba soalan ini lagi” dalam chat.',
    ...
    'home.firstTask.detail': 'Persediaan anda disimpan. Mulakan dengan balasan pelanggan, pelan mingguan, atau promosi dalam chat web. Sambungan WhatsApp atau Telegram tidak diperlukan.',
    ...
    'ask.welcome.first': 'Beri Jentera tugasan pertama. Pilih draf di bawah atau terangkan keperluan anda. Anda boleh bekerja di sini tanpa menyambungkan WhatsApp atau Telegram.',
    'ask.first.reply.label': 'Draf balasan pelanggan',
    'ask.first.reply.prompt': 'Draf balasan mesra kepada pelanggan yang bertanya tentang harga kami. Gunakan pengetahuan tentang perniagaan saya dan ruang isian untuk maklumat yang tiada. Simpan sebagai draf untuk semakan saya.',
    'ask.first.plan.label': 'Rancang minggu saya',
    'ask.first.plan.prompt': 'Draf pelan mingguan ringkas untuk perniagaan saya dengan tiga keutamaan dan langkah praktikal. Tanya saya tentang maklumat perniagaan yang diperlukan.',
    'ask.first.promotion.label': 'Tulis promosi',
    'ask.first.promotion.prompt': 'Draf promosi ringkas untuk perniagaan saya. Gunakan ruang isian untuk harga, tawaran atau tarikh yang anda tidak tahu. Simpan sebagai draf untuk semakan saya.',
