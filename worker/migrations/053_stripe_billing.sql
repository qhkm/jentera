-- Stripe Billing (integration migration 053; branch migration 051).
--
...
--
-- 051 remains reserved by the deferred external-trigger pilot. Do not restore
-- that pilot or reuse its migration number when integrating billing.
