...
:root{color-scheme:dark;--bg:#080808;--surface:#181818;--ink:#f2f2f2;--muted:#aaa;--line:rgb(255 255 255 / .12);--soft:#242424;--accent:#4aebb5;--accent-ink:#080808;--primary:#f3f7f5;--primary-ink:#101514;--focus:#72efc5;--radius-card:16px;--radius-item:13px;--radius-control:12px}
...
interface Base { slug: string; lang: Lang; businessName: string; location?: string | null; brandColor?: string; logoUrl?: string | null }

const branding = (input: Base) => ({ brandColor: input.brandColor, logoUrl: input.logoUrl });
...
function layout(input: { lang: Lang; title: string; body: string; langSwitch?: string; widget?: boolean; businessName?: string; location?: string | null; step?: number; brandColor?: string; logoUrl?: string | null }): string {
