...
/** Explicit, owner-started browser demonstration capture. Values, headers,
 * cookies, request/response bodies, screenshots and coordinates never enter
 * this object. It observes the headed browser as the owner drives it over
 * VNC, rather than relying on Jentera's fallback click API. */
...
export const procedureRecorderInternals = { safeLocation, compileDraft };
